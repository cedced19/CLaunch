...
public class GameUpdater implements Runnable
{
	...
	public String JarFile = "http://cedced19.github.io/CLaunch/minecraft.jar";
	public String VersionFileTxt = "http://cedced19.github.io/CLaunch/version.txt";
	public String ZipFile = "http://cedced19.github.io/CLaunch/mods.zip";
	public static String WorkingDirectory = "minecraft";
	public static String Title = "CLaunch";
	public static String urlNews = "http://cedced19.github.io/CLaunch/";
	...
	protected void loadJarURLs() throws Exception
	{
		...
		for (int i = 0; i < jarCount - 1; i++)
		{
			...
			if (nextToken.indexOf("minecraft.jar") >= 0)
			{
				this.urlList[i] = new URL(path, nextToken.replaceAll("minecraft.jar", "minecraft.jar"));
			}
			else
			{
	...
	public void downloadFile(String pathFolder) {
		...
		zip.delete();
		System.out.println("Merci d'avoir utiliser ce launcher. Décompilé, amélioré et optimisé par lucsw");
}
